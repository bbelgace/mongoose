...
//const newPerson=new Person({name:"hamza",age:44,favoriteFoods: ["pasta","chikken"]});
//newPerson
//.save()
//.then((Person)=>console.log(Person))
// .catch((err)=>console.log(err));
//  const newPerson=new Person({name:"kaka",age:10,favoriteFoods: ["kosksi","chikken"]});
//newPerson
//  .save()
//.then((Person)=>console.log(Person))
//.catch((err)=>console.log(err));
...
Person.findOneAndUpdate(
  { id: "61a20d99e6335a0101c9efc8" },
  { $set: { age: 20 } },
  { new: true, useFindAndModify: false }
)
  .then((Person) => console.log(Person))
  .catch((err) => console.log(err));
Person.findByIdAndRemove({ _id: "61a20d99e6335a0101c9efc8" })
  .then((Person) => console.log(Person))
  .catch((err) => console.log(err));
Person.find()
  .then((Person) => console.log(Person))
